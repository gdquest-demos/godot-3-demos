...
onready var player: Position2D = $".."/Player
onready var dummy: Position2D = $".."/Dummy
...
func _ready() -> void:
	...
	dummy.connect("damaged", self, "_on_Dummy_damaged")
...
func _on_Player_attacked(damage) -> void:
	var key := "active"
...
func _on_Dummy_damaged(damage) -> void:
	var key := "active"
